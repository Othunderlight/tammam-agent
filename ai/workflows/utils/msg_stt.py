...
async def _transcribe_gemini(
    ...
    try:
        ...
        api_url = f"https://aiplatform.googleapis.com/v1beta1/projects/{GOOGLE_CLOUD_PROJECT_NAME}/locations/{GOOGLE_CLOUD_PROJECT_LOCATION}/publishers/google/models/{model}:generateContent?key={GEMINI_API_KEY}"
